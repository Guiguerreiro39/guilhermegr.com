...
export const ProgrammingLanguages = ({ className }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="japanese:sm:-right-20 japanese:sm:bottom-0 japanese:left-auto japanese:-bottom-12 japanese:right-10 retro:sm:-right-10 retro:md:-right-20 absolute right-12 -bottom-14 flex items-center gap-1 sm:-right-24 sm:-bottom-2 md:-right-16">
        <Icon
